!(function(t, e) {
    ...
    return "path" !== M && t.getBBox
      ? ((h = (function _createPath(t, e) {
        ...
        "rect" === M
          ...
          : ("polyline" !== M && "polygon" !== M) ||
            ((n =
              "M" +
              (r = (g =
                (t.getAttribute("points") + "").match(b) || []).shift()) +
              "," +
              (o = g.shift()) +
              " L" +
              g.join(",")),
    ...
    if (t !== h || e !== s) {
      ...
      for (X = 0; X < Y; X++)
        (_ = k((o = V + X * j))),
          ...
          (R = k((o += j))),
          (A = E(o)),
          I.push(_ - G * m, m + G * _, R + G * A, A - G * R, R, A);
      for (X = 0; X < I.length; X += 2)
        (_ = I[X]),
          (m = I[X + 1]),
          (I[X] = _ * U + m * H + b),
          (I[X + 1] = _ * q + m * B + N);
  ...
  function stringToRawPath(t) {
    ...
    for (e = 0; e < P; e++)
      if (
        ((f = i),
        isNaN(_[e]) ? (a = (i = _[e].toUpperCase()) !== _[e]) : e--,
        (r = +_[e + 1]),
        (o = +_[e + 2]),
        a && ((r += w), (o += v)),
        e || ((s = r), (l = o)),
        ...
        h && (h.length < 8 ? --m.length : (y += h.length)),
          (w = s = r),
          (v = l = o),
          (h = [r, o]),
          m.push(h),
        ...
        (g = w),
          (c = v),
          ("C" !== f && "S" !== f) ||
            ((g += w - h[h.length - 4]), (c += v - h[h.length - 3])),
          a || (w = v = 0),
          h.push(g, c, r, o, (w += 1 * _[e + 3]), (v += 1 * _[e + 4])),
          (e += 4);
      else if ("Q" === i)
        (g = w + (2 / 3) * (r - w)),
          (c = v + (2 / 3) * (o - v)),
          ...
          (w += 1 * _[e + 3]),
          (v += 1 * _[e + 4]),
          h.push(g, c, w + (2 / 3) * (r - w), v + (2 / 3) * (o - v), w, v),
          (e += 4);
      else if ("T" === i)
        (g = w - h[h.length - 4]),
          (c = v - h[h.length - 3]),
    ...
    for (
      ...
      for (n = (a = t[w]).length, i = 6; i < n; i += 6)
        for (
          ...
          v <
          (r =
            ((s = T * h) * s * u + 3 * (l = 1 - s) * (s * f + l * p)) * s + g)
            ? (v = r)
            : r < P && (P = r),
            y < (o = (s * s * m + 3 * l * (s * _ + l * d)) * s + c)
              ? (y = o)
              : o < x && (x = o);
    return (
      (t.centerX = (v + P) / 2),
  ...
  function Y(t, e, n) {
    var r,
      ...
      p = 0;
    for (i = 6; i < a; i += 6)
      (o = X(t, e, i / 6, l, g)) < c && ((c = o), (p = i));
    if (n)
      for (reverseSegment((r = t.slice(0))), i = 6; i < a; i += 6)
        (o = X(r, e, i / 6, l, g)) < c && ((c = o), (p = -i));
    return p / 6;
  }
  function Z(t, e, n) {
    for (var r, o, i, a, h, s, l = t.length, g = 1e20, c = 0, p = 0; -1 < --l; )
      for (s = (r = t[l]).length, h = 0; h < s; h += 6)
        (o = r[h] - e),
          (i = r[h + 1] - n),
          (a = w(o * o + i * i)) < g && ((g = a), (c = r[h]), (p = r[h + 1]));
    return [c, p];
  }
  function $(t, e, n, r, o, i) {
    var a,
      ...
      u = t.centerX + o,
      d = t.centerY + i;
    for (a = n; a < g && !((e[a].size || S(e[a])) < p); a++)
      (h = e[a].centerX - u),
        (s = e[a].centerY - d),
        (l = w(h * h + s * s)) < f && ((c = a), (f = l));
        ...
        for (
          p < 0 && (p = -p),
            f[0].length > u[0].length &&
              _(u[0], ((f[0].length - u[0].length) / 6) | 0),
            v = u.length;
          d < p;

        )
          f[v].size || S(f[v]),
            (s = (h = Z(u, f[v].centerX, f[v].centerY))[0]),
            (l = h[1]),
            (u[v++] = [s, l, s, l, s, l, s, l]),
            (u.totalPoints += 8),
            d++;
            ...
            (Math.abs(a[0] - a[a.length - 2]) < 0.5 &&
              ...
              ? "auto" === n || "log" === n
                ? ((P[v] = n = Y(a, i, !v || !1 === o)),
                  ...
                  W(a, 6 * n))
                : "reverse" !== n &&
                  (v && n < 0 && reverseSegment(a), W(a, 6 * (n < 0 ? -n : n)))
              : !y &&
                (("auto" === n &&
                  Math.abs(i[0] - a[0]) +
                    Math.abs(i[1] - a[1]) +
  ...
  function ha(t, e) {
    for (
      var n, r, o, i, a, h, s, l, g, c, p, f, u = t.length, d = 0.2 * (e || 1);
      -1 < --u;
  ...
  function ma(t) {
    (n = y()),
      ...
      n && o
        ? ((C = n.utils.toArray), (o.prototype._tweenRotation = la), (I = 1))
        : t && L("Please gsap.registerPlugin(MorphSVGPlugin)");
  }
  var n,
    C,
    F,
    ...
    H = (function(t) {
      for (
        var e =
            ...
            -1 !== t.indexOf(O(108, 111, 99, 97, 108, 104, 111, 115, 116)) ||
            -1 !== t.indexOf(O(49, 50, 55, 46, 48, 32, 48, 46, 49)),
          n = [
            a,
            ...
            O(116, 119, 101, 101, 110, 108, 105, 116, 101, 46, 99, 111, 109),
    ...
    K = {
      ...
      init: function init(t, e, n, r, o) {
        var i,
          ...
          S,
          b,
          N = t.nodeType ? window.getComputedStyle(t) : {},
          R = N.fill + "",
          A = !(
            "none" === R ||
            "0" === (R.match(j) || [])[3] ||
        ...
        if (
          ...
          return L("Cannot morph a <" + i + "> element. " + B), !1;
        if (
          ((a = "PATH" === i ? "d" : "points"),
            ...
            return (
              (!("string" == typeof t) ||
                ...
                ((r = C(t)[0])
                  ...
                  : (L("WARNING: invalid morph to: " + t), (t = !1))),
              t
            );
          })(e.shape || e.d || e.points || "", "d" == a, t)),
          l && q.test(s))
        )
          return L("A <" + i + "> cannot accept path data. " + B), !1;
        if (
            ...
            for (
              ("log" !== e.precompile && !0 !== e.precompile) ||
                ...
                (S = "linear" !== (e.type || K.defaultType)) &&
                  ((u = ha(u, e.smoothTolerance)),
                  (d = ha(d, e.smoothTolerance)),
                  u.size || T(u),
                  d.size || T(d),
                  (O = ia(z[0])),
                  ...
                  (S
                    ? p[_] && f[_]
                      ? ((x = v.smoothData),
                        ...
                        (h = this._tweenRotation(v, P, _ + 2)),
                        this._tweenRotation(v, P, _, h),
                        this._tweenRotation(v, P, b - 1, h),
                        (_ += 4))
                      : this._tweenRotation(v, P, _)
                    : ((h = this.add(v, _, v[_], P[_])),
                      (h = this.add(v, _ + 1, v[_ + 1], P[_ + 1]) || h)));
          } else
            h = this.add(
              t,
              "setAttribute",
        ...
        if (1 === t && e._apply)
          for (v = e._pt; v; )
            v.end &&
              (e._prop
                ? (w[e._prop] = v.end)
                : w.setAttribute(v.endProp, v.end)),
              (v = v._next);
        else if (u) {
          for (; _; )
            (a = _.sa + t * _.ca),
              (i = _.sl + t * _.cl),
              (_.t[_.i] = e._origin.x + x(a) * i),
              (_.t[_.i + 1] = e._origin.y + z(a) * i),
              (_ = _._next);
          for (r = t < 0.5 ? 2 * t * t : (4 - 2 * t) * t - 1; d; )
            (f =
              (h = d.i) + (h === (o = u[d.j]).length - 4 ? 7 - o.length : 5)),
              (a = P(o[f] - o[h + 1], o[f - 1] - o[h])),
              (c = z(a)),
              (p = x(a)),
              (l = o[h + 2]),
              (g = o[h + 3]),
      ...
      pathFilter: function _pathFilter(t, e, n, r, o) {
        ...
        aa(i, a, e || 0 === e ? e : "auto", n, o) &&
          ((t[0] = rawPathToString(i)),
          (t[1] = rawPathToString(a)),
          ("log" !== r && !0 !== r) ||
            L('precompile:["' + t[0] + '","' + t[1] + '"]'));
      },
      pointsFilter: ea,
      getTotalSize: T,
